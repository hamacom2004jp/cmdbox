...
| cmd | load |
| クラス | RagLoad |
| モジュール | cmdbox.app.features.cli.cmdbox_rag_load |
| 実装ファイル | /home/ubuntu/cmdbox/cmdbox/app/features/cli/cmdbox_rag_load.py |
...
- 日本語: RAG（検索拡張生成）の設定を読み込みます。
- 英語: Loads the settings for RAG (Retrieval-Augmented Generation).
...
| --rag_name | 文字列 | はい | いいえ | いいえ | None | - | ロードするRAG設定の名前を指定します。 |
