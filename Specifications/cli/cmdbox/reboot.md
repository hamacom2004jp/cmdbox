...
| cmd | reboot |
| クラス | CmdboxReboot |
| モジュール | cmdbox.app.features.cli.cmdbox_cmdbox_reboot |
| 実装ファイル | /home/ubuntu/cmdbox/cmdbox/app/features/cli/cmdbox_cmdbox_reboot.py |
...
- 処理フロー:
  ...
  - reboot_ret に self.reboot の結果を格納する
  - common.print_format を呼び出す
  - 条件 'success' not in reboot_ret を満たす場合は早期終了し、RESP_WARN
