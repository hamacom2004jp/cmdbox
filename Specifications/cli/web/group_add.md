...
| --- | --- | --- | --- | --- | --- | --- | --- |
| --group_id | 文字列 | はい | いいえ | いいえ | None | - | グループIDを指定します。他のグループと重複しないようにしてください。 |
| --group_name | 文字列 | はい | いいえ | いいえ | None | - | グループ名を指定します。他のグループと重複しないようにしてください。 |
| --group_parent | 文字列 | いいえ | いいえ | いいえ | None | - | 親グループ名を指定します。 |
...
- 処理フロー:
  ...
  - 例外処理を伴って処理する。主な呼出: web.Web, dict, w.group_add, common.print_format
