...
| --session_id | 文字列 | はい | いいえ | いいえ | None | - | Runnerに送信するセッションIDを指定します。 |
...
- 結果キー候補: success, end
- 処理フロー:
  - 例外処理を伴って処理する。主な呼出: json.loads, payload.get, self.load_conf, self.create_session_service, dict, redis_cli.rpush
