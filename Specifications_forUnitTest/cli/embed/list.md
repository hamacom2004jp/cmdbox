...
| cmd | list |
| クラス | EmbedList |
| モジュール | cmdbox.app.features.cli.cmdbox_embed_list |
| 実装ファイル | /home/ubuntu/cmdbox/cmdbox/app/features/cli/cmdbox_embed_list.py |
| 詳細設計書 | Specifications/cli/embed/list.md |
| 実装上の必須推定 | - |

## 概要

- 日本語: 保存されているエンベッドモデル設定を一覧表示します。
- 英語: Display a list of saved embedding model settings.
