...
| 実装ファイル | /home/ubuntu/cmdbox/cmdbox/app/features/cli/cmdbox_cmdbox_redis_load.py |
...
| TC-006 | 型境界 | install_tag 1文字 | --install_tag に 1 文字値 X を指定する | RESP_WARN | 正常終了し、結果オブジェクトに warn が含まれる | 最短相当の入力でも分岐や検索条件が崩れないことを確認する |
