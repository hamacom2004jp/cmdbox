...
| 実装ファイル | /home/ubuntu/cmdbox/cmdbox/app/features/cli/cmdbox_agent_mcpsv_list.py |
| 詳細設計書 | Specifications/cli/agent/mcpsv_list.md |
| 実装上の必須推定 | - |

## 概要

- 日本語: 保存されているMCPサーバ設定を一覧表示します。
- 英語: Lists saved MCP server configurations.
