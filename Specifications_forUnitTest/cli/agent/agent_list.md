...
| cmd | agent_list |
| クラス | AgentAgentList |
| モジュール | cmdbox.app.features.cli.cmdbox_agent_agent_list |
| 実装ファイル | /home/ubuntu/cmdbox/cmdbox/app/features/cli/cmdbox_agent_agent_list.py |
| 詳細設計書 | Specifications/cli/agent/agent_list.md |
| 実装上の必須推定 | - |

## 概要

- 日本語: 保存されているAgent設定を一覧表示します。
- 英語: Lists saved agent configurations.
