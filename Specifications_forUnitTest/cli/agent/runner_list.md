...
| cmd | runner_list |
| クラス | AgentRunnerList |
| モジュール | cmdbox.app.features.cli.cmdbox_agent_runner_list |
| 実装ファイル | /home/ubuntu/cmdbox/cmdbox/app/features/cli/cmdbox_agent_runner_list.py |
| 詳細設計書 | Specifications/cli/agent/runner_list.md |
| 実装上の必須推定 | - |

## 概要

- 日本語: 保存されているRunner設定を一覧表示します。
- 英語: Lists saved runner configurations.
