...
| cmd | list |
| クラス | ExtractList |
| モジュール | cmdbox.app.features.cli.cmdbox_extract_list |
| 実装ファイル | /home/ubuntu/cmdbox/cmdbox/app/features/cli/cmdbox_extract_list.py |
| 詳細設計書 | Specifications/cli/extract/list.md |
| 実装上の必須推定 | - |

## 概要

- 日本語: 保存されている抽出設定を一覧表示します。
- 英語: Display a list of saved extraction settings.
