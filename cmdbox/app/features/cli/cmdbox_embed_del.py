...
class EmbedDel(feature.OneshotResultEdgeFeature, validator.Validator):
    ...
    def get_option(self) -> Dict[str, Any]:
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="embed_name", type=Options.T_STR, default=None, required=True, multi=False, hide=False, choice=None,
                     description_ja="削除するエンベッドモデルの登録名を指定します。",
                     description_en="Specify the registration name of the embed model to delete."),
            ]
        )
    ...
    def svrun(self, data_dir:Path, logger:logging.Logger, redis_cli:redis_client.RedisClient, msg:List[str],
        ...
        try:
            ...
            msg = dict(success=f"Embed configuration '{embed_name}' deleted from '{str(configure_path)}'.")
            redis_cli.rpush(reskey, msg)
