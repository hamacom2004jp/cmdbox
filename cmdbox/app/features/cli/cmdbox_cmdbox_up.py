...
class CmdboxUp(cmdbox_base.CmdboxBase, validator.Validator):
    ...
    def get_option(self):
        ...
        opt['description_ja'] = "コンテナを起動します。"
        opt['description_en'] = "Starts the container."
        opt['choice'] = [
    ...
    def apprun(self, logger:logging.Logger, args:argparse.Namespace, tm:float, pf:List[Dict[str, float]]=[]) -> Tuple[int, Dict[str, Any], Any]:
        ...
        ret = self.up(logger, args.compose_path, args.container)
