...
class WebGenpass(feature.OneshotResultEdgeFeature, validator.Validator):
    ...
    def output_schema(self) -> type:
        class PasswordData(pydantic.BaseModel):
            password: str = pydantic.Field(..., description="生成されたパスワード")
        class Data(resdata.Data):
            passwords: Union[List[PasswordData], None] = pydantic.Field(default=None, description="生成されたパスワードリスト")
