...
class LimiterPlanDel(feature.OneshotResultEdgeFeature, validator.Validator):
    ...
    def get_option(self) -> Dict[str, Any]:
        return dict(
            ...
            description_ja="プラン設定を削除します。",
            description_en="Deletes a plan configuration.",
            choice=[
                ...
                dict(opt="plan_name", type=Options.T_STR, default=None, required=True, multi=False, hide=False, choice=None,
                     description_ja="削除するプランの識別名を指定します。",
                     description_en="Specify the identifier name of the plan to delete."),
            ]
        )
    ...
    def svrun(self, data_dir: Path, logger: logging.Logger, redis_cli: redis_client.RedisClient, msg: List[str],
        ...
        try:
            ...
            out = dict(success=f"Plan configuration '{plan_name}' deleted from '{configure_path}'.")
            redis_cli.rpush(reskey, out)
