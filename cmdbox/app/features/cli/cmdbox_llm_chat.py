    ...
    def get_option(self) -> Dict[str, Any]:
        return dict(
            ...
            choice=[
                ...
                dict(opt="msg_audio", type=Options.T_FILE, default=None, required=False, multi=False, hide=False, choice=None, fileio="in",
                ...
                dict(opt="msg_file", type=Options.T_FILE, default=None, required=False, multi=False, hide=False, choice=None, fileio="in",
