...
class WebGroupAdd(feature.UnsupportEdgeFeature, validator.Validator, limiter.LimitedFeature):
    ...
    def apprun(self, logger:logging.Logger, args:argparse.Namespace, tm:float, pf:List[Dict[str, float]]=[]) -> Tuple[int, Dict[str, Any], Any]:
        ...
        try:
            ...
            group = dict(gid=args.group_id, name=args.group_name, home=args.group_home, parent=args.group_parent, startpage=args.startpage)
            w.group_add(group)
