...
class RagLoad(feature.OneshotResultEdgeFeature, validator.Validator):
    ...
    def get_option(self) -> Dict[str, Any]:
        ...
        return dict(
            ...
            description_ja="RAG（検索拡張生成）の設定を読み込みます。",
            description_en="Loads the settings for RAG (Retrieval-Augmented Generation).",
            choice=[
                ...
                dict(opt="rag_name", type=Options.T_STR, default=None, required=True, multi=False, hide=False, choice=None,
                     description_ja="ロードするRAG設定の名前を指定します。",
                     description_en="Specify the name of the RAG configuration to load."),
    ...
    def apprun(self, logger: logging.Logger, args: argparse.Namespace, tm: float, pf: List[Dict[str, float]] = []) -> Tuple[int, Dict[str, Any], Any]:
        ...
        cached = self._cache.get(args.rag_name)
        ...
        # 読み込んだ設定をキャッシュする
        self._cache.set(args.rag_name, ret.get('success', None), args.cache_timeout)
