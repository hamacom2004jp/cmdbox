    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="pg_host", type=Options.T_STR, default='pgsql', required=False, multi=False, hide=True, choice=None, web="mask",
                ...
                dict(opt="pg_user", type=Options.T_STR, default='pgsql', required=False, multi=False, hide=True, choice=None, web="mask",
