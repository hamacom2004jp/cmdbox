...
class LLMLoad(feature.OneshotResultEdgeFeature, validator.Validator):
    ...
    def apprun(self, logger: logging.Logger, args: argparse.Namespace, tm: float, pf: List[Dict[str, float]] = []) -> Tuple[int, Dict[str, Any], Any]:
        ...
        cached = self._cache.get(args.llmname)
        ...
        # 読み込んだ設定をキャッシュする
        self._cache.set(args.llmname, ret.get('success', None), args.cache_timeout)
