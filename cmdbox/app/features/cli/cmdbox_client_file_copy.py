...
class ClientFileCopy(feature.UnsupportEdgeFeature, validator.Validator):
    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="from_fwpath", type=Options.T_FILE, default=None, required=True, multi=True, hide=False, choice=None,
                ...
                dict(opt="to_fwpath", type=Options.T_FILE, default=None, required=True, multi=True, hide=False, choice=None,
                     description_ja="指定したパスが範囲外であるかどうかを判定するパスを指定します。このパスの配下でない場合エラーにします。",
                     description_en="Specify the path to determine whether the specified path is out of bounds. If it is not under this path, it will result in an error.",),
    ...
    def output_schema(self) -> type:
        class Data(resdata.Data):
            ...
            to_path: Union[str, None] = pydantic.Field(default=None, description="コピー先・移動先のパス")
            from_path: Union[str, None] = pydantic.Field(default=None, description="コピー元・移動元のパス")
