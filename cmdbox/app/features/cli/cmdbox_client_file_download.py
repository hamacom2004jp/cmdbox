            ...
            choice=[
                ...
                dict(opt="scope", type=Options.T_STR, default="client", required=True, multi=False, hide=False, choice=["client", "current", "server"],
                     ...
                     test_true={"server":"server",
                                "client":"client",
                                "current":"current"}),
                dict(opt="rpath", type=Options.T_STR, default="", required=False, multi=False, hide=False, choice=None,
                ...
                dict(opt="download_file", type=Options.T_FILE, default="", required=False, multi=False, hide=False, choice=None, fileio="out",
