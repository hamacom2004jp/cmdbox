...
class ExtractLoad(feature.OneshotResultEdgeFeature, validator.Validator):
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="extract_name", type=Options.T_STR, default=None, required=True, multi=False, hide=False, choice=None,
                     description_ja="ロードする抽出設定の名前を指定します。",
                     description_en="Specify the name of the extraction configuration to load."),
    ...
    def apprun(self, logger: logging.Logger, args: argparse.Namespace, tm: float, pf: List[Dict[str, float]] = []) -> Tuple[int, Dict[str, Any], Any]:
        ...
        cached = self._cache.get(args.extract_name)
        ...
        # 読み込んだ設定をキャッシュする
        self._cache.set(args.extract_name, ret.get('success', None), args.cache_timeout)
