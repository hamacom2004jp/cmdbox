...
class WorkflowDagDel(feature.OneshotResultEdgeFeature, validator.Validator):
    ...
    def get_option(self) -> Dict[str, Any]:
        return dict(
            ...
            description_ja="DAGワークフロー定義を削除します。",
            description_en="Deletes a DAG workflow definition.",
            choice=[
                ...
                dict(opt="dag_name", type=Options.T_STR, default=None, required=True, multi=False, hide=False, choice=[],
                    callcmd="async () => {await cmdbox.callcmd('workflow','dag_list',{},(res)=>{"
                            ...
                            + "}",
                    description_ja="削除するDAGの名前を指定します。",
                    description_en="Specify the name of the DAG to delete."),
            ]
        )
    ...
    def svrun(self, data_dir:Path, logger:logging.Logger, redis_cli:redis_client.RedisClient, msg:List[str],
        ...
        try:
            ...
            dag_path.unlink()
            redis_cli.rpush(reskey, dict(success=f"DAG '{name}' deleted."))
