...
class AuditCreatedb(feature.UnsupportEdgeFeature):
    ...
    def get_option(self):
        ...
        return dict(
            ...
            choice=[
                dict(opt="pg_host", type=Options.T_STR, default='pgsql', required=True, multi=False, hide=False, choice=None,
                ...
                dict(opt="pg_user", type=Options.T_STR, default='pgsql', required=True, multi=False, hide=False, choice=None,
                     description_ja="postgresqlのユーザー名を指定する。",
                     description_en="Specify the postgresql user name."),
                dict(opt="pg_password", type=Options.T_PASSWD, default='pgsql', required=True, multi=False, hide=False, choice=None,
