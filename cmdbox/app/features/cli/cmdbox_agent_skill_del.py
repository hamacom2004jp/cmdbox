...
class AgentSkillDel(feature.OneshotResultEdgeFeature, validator.Validator):
    ...
    def get_option(self) -> Dict[str, Any]:
        return dict(
            ...
            description_ja="Agentスキルマニフェストを削除します。",
            description_en="Deletes an Agent skill manifest.",
            choice=[
                ...
                dict(opt="skill_name", type=Options.T_STR, default=None, required=True, multi=False, hide=False, choice=None,
                    description_ja="削除するスキルの名前を指定します。",
                    description_en="Specify the name of the skill to delete."),
            ]
        )
    ...
    def svrun(self, data_dir:Path, logger:logging.Logger, redis_cli:redis_client.RedisClient, msg:List[str],
        ...
        try:
            ...
            skill_path.unlink()
            redis_cli.rpush(reskey, dict(success=f"Skill '{name}' deleted."))
