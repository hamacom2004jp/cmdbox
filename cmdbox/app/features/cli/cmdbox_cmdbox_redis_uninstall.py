...
class CmdboxRedisUninstall(cmdbox_base.CmdboxBase):
    ...
    def get_option(self):
        ...
        opt['description_ja'] = "cmdboxのRedisをアンインストールします。"
        opt['description_en'] = "Uninstalls the cmdbox Redis."
        opt['choice'] = [
    ...
    def apprun(self, logger:logging.Logger, args:argparse.Namespace, tm:float, pf:List[Dict[str, float]]=[]) -> Tuple[int, Dict[str, Any], Any]:
        ...
        """
        ret = self.uninstall(logger, args.compose_path, 'redis', None)
