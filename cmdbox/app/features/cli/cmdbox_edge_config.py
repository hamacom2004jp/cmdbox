        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="saml", type=Options.T_STR, default=None, required=False, multi=False, hide=False, choice=["", "azure"],
                     ...
                     choice_show=dict(azure=["saml_tenant_id","saml_idp_cert"])),
                ...
                dict(opt="saml_idp_cert", type=Options.T_FILE, default=None, required=False, multi=False, hide=False, choice=None,
                     discription_ja="SAML認証を使用するときのサーバー証明書を指定します。PEM形式のファイルを指定する必要があります。",
                     discription_en="Specifies the server certificate when using SAML authentication; must be a PEM format file."),
