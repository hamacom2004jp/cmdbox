    ...
    def get_option(self) -> Dict[str, Any]:
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="session_store_pghost", type=Options.T_STR, default='localhost', required=False, multi=False, hide=False, choice=None, web="mask",
                    description_ja="セッション保存用PostgreSQLホストを指定します。",
                    description_en="Specify the postgresql host for session store."),
                dict(opt="session_store_pgport", type=Options.T_INT, default=5432, required=False, multi=False, hide=False, choice=None, web="mask",
                    description_ja="セッション保存用PostgreSQLポートを指定します。",
                    description_en="Specify the postgresql port for session store."),
                dict(opt="session_store_pguser", type=Options.T_STR, default='postgres', required=False, multi=False, hide=False, choice=None, web="mask",
                    description_ja="セッション保存用PostgreSQLのユーザー名を指定します。",
                    description_en="Specify the postgresql user name for session store."),
                dict(opt="session_store_pgpass", type=Options.T_STR, default='postgres', required=False, multi=False, hide=False, choice=None, web="mask",
