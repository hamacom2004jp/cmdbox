...
class AgentMemorySave(feature.OneshotResultEdgeFeature, validator.Validator):
    ...
    def get_option(self) -> Dict[str, Any]:
        ...
        return dict(
            ...
            choice=[
                ...
                dict(opt="memory_store_pghost", type=Options.T_STR, default='pgsql', required=False, multi=False, hide=False, choice=None,
                ...
                dict(opt="memory_store_pguser", type=Options.T_STR, default='pgsql', required=False, multi=False, hide=False, choice=None,
                    description_ja="メモリサービス用PostgreSQLのユーザー名を指定します。",
                    description_en="Specify the postgresql user name for memory service."),
                dict(opt="memory_store_pgpass", type=Options.T_PASSWD, default='pgsql', required=False, multi=False, hide=False, choice=None,
                    description_ja="メモリサービス用PostgreSQLのパスワードを指定します。",
                    description_en="Specify the postgresql password for memory service."),
                dict(opt="memory_store_pgdbname", type=Options.T_STR, default='pgsql', required=False, multi=False, hide=False, choice=None,
    ...
    def apprun(self, logger: logging.Logger, args: argparse.Namespace, tm: float, pf: List[Dict[str, float]] = []) -> Tuple[int, Dict[str, Any], Any]:
        ...
        if args.memory_type == 'postgresql':
