...
class UserData(feature.WebFeature):
    def route(self, web:Web, app:FastAPI) -> None:
        ...
        @app.post('/signin/gui/user_data/load', responses=feature.WebFeature.DEFAULT_RESPONCE_STATES)
        ...
        @app.post('/signin/gui/user_data/save', responses=feature.WebFeature.DEFAULT_RESPONCE_STATES)
        ...
        @app.post('/signin/gui/user_data/delete', responses=feature.WebFeature.DEFAULT_RESPONCE_STATES)
        ...
        @app.post('/signin/gui/user_data/icon', responses=feature.WebFeature.DEFAULT_RESPONCE_STATES)
